...
description: "Diagnose and fix C# compilation errors (CS0246, CS0103, etc.) — missing using statements, wrong namespace, unresolved types."
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [csharp, compilation, build-errors, cs0246, cs0103, using-statements]
---
...
- Any "does not contain a definition for" on static members from another file
...
Note the exact error code (CS0246, CS0103) and the missing type name.
...
| CS1061 | Member doesn't contain definition | Check type, add using, verify static/instance |
